...
class AlertSpec extends ObjectBehavior
{
	...
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::create', [null, null]);
		$this->shouldHaveType('Cornford\Alerter\Alert');
	}

	function it_throws_exception_when_created_without_type()
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::create', [Alert::TYPE_NONE, 'None']);
	...
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::create', [Alert::TYPE_INFO, 'Info message']);
	...
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::create', [Alert::TYPE_ERROR, 'Error message']);
	...
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::create', [Alert::TYPE_WARNING, 'Waring message']);
	...
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::error', ['Error message']);
		$this->content->shouldEqual('Error message');
	}

	function it_can_be_created_as_a_type_info()
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::info', ['Info message']);
		$this->content->shouldEqual('Info message');
	}

	function it_can_be_created_as_a_type_warning()
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::warning', ['Warning message']);
		$this->content->shouldEqual('Warning message');
	}

	function it_can_be_created_as_a_type_success()
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::success', ['Success message']);
		$this->content->shouldEqual('Success message');
	}

	function it_can_be_created_as_a_type_none()
	{
		$this->beConstructedThrough('Cornford\Alerter\Alert::none', ['Message']);
